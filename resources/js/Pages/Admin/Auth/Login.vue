...
const applyDemoAccount = async (role: 'admin' | 'employee') => {
    if (role === 'admin') {
    ...
    >
        ...
        <div class="branded-bg relative flex flex-col items-center justify-center overflow-hidden p-12 text-white lg:w-1/2">
            ...
            <div class="relative z-10 max-w-lg text-left">
                ...
                <h1 class="mb-4 text-3xl leading-tight font-bold lg:text-4xl">Manage invoices with ease.</h1>
                <p class="mb-6 text-base leading-relaxed font-light text-primary-100 lg:text-lg">
                    Create, send, and track invoices. Manage customers and payments from one powerful platform.
                </p>
                <!-- Feature Bullets -->
                <div class="mb-12 space-y-3">
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium text-primary-100">Professional invoice management</span>
                    </div>
                    <div class="flex items-start space-x-3">
                        <svg class="mt-1 h-5 w-5 shrink-0 text-primary-300" fill="currentColor" viewBox="0 0 512 512">
                            <path
                        ...
                        <span class="font-medium text-primary-100">Real-time payment tracking</span>
                    </div>
                    <div class="flex items-start space-x-3">
                        <svg class="mt-1 h-5 w-5 shrink-0 text-primary-300" fill="currentColor" viewBox="0 0 512 512">
                            <path
                        ...
                        <span class="font-medium text-primary-100">Advanced reporting tools</span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="group relative flex-1">
                                <input
                                    id="captcha"
                                    type="text"
                                    class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 font-medium text-slate-700 transition-all duration-300 outline-none placeholder:text-slate-400 focus:border-primary-500 focus:bg-white focus:ring-4 focus:ring-primary-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:bg-gray-800 dark:focus:ring-primary-500/20"
                                    :placeholder="__('1234')"
                    ...
                    <div v-if="isDemoMode" class="mt-8 space-y-4">
                        ...
                        >
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="text-left">
                                    <div class="text-sm font-bold text-slate-700 dark:text-white">Admin Account</div>
                        ...
                        <button
                            type="button"
                            @click="applyDemoAccount('employee')"
                            class="group relative flex w-full items-center justify-between overflow-hidden rounded-xl border border-slate-200 bg-white p-4 transition-all hover:border-primary-500 hover:shadow-lg dark:border-gray-700 dark:bg-gray-900"
                        >
                            <div class="flex items-center space-x-3">
                                <div
                                ...
                                <div class="text-left">
                                    <div class="text-sm font-bold text-slate-700 dark:text-white">Employee Account</div>
                                    <div class="text-xs text-slate-400">employee@example.com</div>
                                </div>
                            </div>
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-slate-50 transition-colors group-hover:bg-primary-50 dark:bg-gray-800 dark:group-hover:bg-primary-900/50"
